...
```
knitr::include_url('https://github.com/BayLab/MarineGenomics/Week1_Intro_jetstream/MarineGenomics_Lecture1.ppt')
```
...
knitr::include_graphics("../jetstream/Fig1.png")
```


```{r two, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../jetstream/Fig2.png")
```
...
knitr::include_graphics("../jetstream/Fig3.png")
```
...
knitr::include_graphics("../jetstream/Fig4.png")
```
...
knitr::include_graphics("../jetstream/Fig5.png")
```

```{r six, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../jetstream/Fig6.png")
```

```{r seven, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../jetstream/Fig7.png")
```
...
knitr::include_graphics("../jetstream/Fig11.png")
```

```{r twelve, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../jetstream/Fig12.png")
```
...
knitr::include_graphics("../jetstream/Fig13.png")
```
...
knitr::include_graphics("../jetstream/Fig14.png")
```
...
```html
$ git clone (git://path/to/datafile/MarineGenomics/Week1_intro_jetstream/untrimmed_fastq/)
```
